				...
				<div class="col-md-8">
					<form method="GET" action="">
						...
						<div class="form-group">
							...
							<input type="text" name="formulaNE" id="formulaNE" value="0.4" />
						</div>
						<br />
						<div class="form-group">
							...
							<input type="text" name="formulaFL" id="formulaFL" value="1.0" />
						...
						<div class="form-group">
							...
							<input type="text" name="formulaFI" id="formulaFI" value="1.0" />
						</div>
						<br />
						<div class="form-group">
							...
							<input type="text" name="formulaFC" id="formulaFC" value="0.2" />
						</div>
						<br />
						<div class="form-group">
							...
							<input type="text" name="formulaL" id="formulaL" value="320.0" />
						</div>
